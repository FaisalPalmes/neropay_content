...
**v3, 25 Sep 2026.** Faisal on the v2 result: the framing and the realism are right. The table was arranged like a
diagram, with everything spread out to fit in frame and the matcha on the very edge. v3 fixes it:
- **Placement:** the plate is close to her, just beyond the phone, and the phone overlaps its near rim. The matcha
  and the water sit inwards.
- **Props:** the napkin is replaced with a small shoulder bag.
- **Nails:** light pink with gold gel art.
- **A standing line for every café prompt:** nothing has to be fully in frame. Things overlap, hide behind each other
  and are cut by the frame edge, as in a real photograph. Only the phone screen and the pressing finger must be fully
  visible.

**C2. The landing, overhead on a terrace table (generate first; this is the end frame of the dive)**
```
Overhead photograph of a brunch table on a café's pavement terrace, looking like a real candid frame shot on film, not a render and not a styled flat lay. Late morning on a bright, sunny autumn day in a northern English city. The camera points straight down from about 1.2 metres above a small round white Carrara marble bistro table, about 60 cm across, in the middle of the frame. The top of the frame is the street side; the bottom of the frame is where she sits.

Framing, like a real photograph: nothing needs to be fully in the frame. Objects overlap and hide parts of each other, and the edges of the frame cut through the table, the chairs, the pavement and anything near them, as they would in a real, unposed photo. The table is lived on, not arranged for the camera. The only things that must be fully visible are the phone's screen, with all four of its corners, and her pressing finger.

Where she sits: at the bottom edge of the frame, facing the street, in a woven rattan bistro chair. From above we see only the two curved bamboo-framed rattan armrests of her chair, cut by the lower corners of the frame, and between them her knees and thighs in light-wash straight-leg jeans. We never see her face, head or shoulders. Her forearms come up onto the table from the bottom edge of the frame, in the pushed-up sleeves of an oversized cream cable-knit jumper.

How she uses the phone, as a real person does: she holds it in her left hand, low over the table just in front of her, her left forearm resting along the near edge of the table. The phone is upright in portrait orientation, its top pointing away from her towards the street, and it leans back in her hand at a shallow angle of about 20 degrees, so the screen faces up towards the camera. Her left fingers wrap around the left side and the back of the phone, their tips just showing along the left side between the corners, and her left thumb rests on the phone's left frame, not on the screen. Her right hand comes up from her side of the table, from below the phone, wrist relaxed, her right forearm resting on the table edge: her index finger is extended and just touching the lower middle of the screen, pressing a button, her other fingers loosely curled under. The rest of her right hand stays below the phone, off the screen. The phone is in the centre of the frame and fills about 40% of the frame height. All four corners of the screen are clearly visible, with the thin black bezel showing all the way round; one lower corner shows on each side of her index finger, and no finger lies along an edge.
...
On the table, as she left it mid-brunch:
- Her brunch, right in front of her, just beyond the phone and a little to the right, so the phone overlaps the near rim of the plate: a round speckled oatmeal stoneware plate with two slices of toasted sourdough topped with whipped ricotta, blistered roasted cherry tomatoes on the vine and a soft poached egg, its yolk already broken and running, one corner of a slice already cut off and eaten. A fork and a knife with brushed-brass handles rest on the plate where she put them down, angled towards her.
- An iced matcha latte in a clear, straight-sided glass, a soft milky pale jade green over white milk, with a few ice cubes and a plain white paper straw, standing on the table beyond the plate, towards the middle of the table and well in from its edge, partly hidden behind the plate from this angle.
- A small clear glass carafe of water and a clear tumbler, half full, standing together beyond the phone on the left side of the table, in from the edge.
- A pair of folded tortoiseshell sunglasses lying beside the carafe.
- Her small shoulder bag lying on the left side of the table near her left elbow: a compact tan leather crossbody bag with a gold clasp, its thin strap trailing loosely over the edge of the table and out of the frame.
- A few sourdough crumbs on the marble. Nothing else is on the table.
...
- Beyond the table at the top of the frame: a strip of pale grey sandstone paving slabs, then a granite kerb, then dark asphalt road in bright sun with a worn double yellow line along its edge, a cast-iron drain grate and a few fallen leaves in the gutter. The crisp scalloped shadow of the awning's hem runs across the paving between the table and the kerb.
- Left: part of a neighbouring round marble table, empty, cut off by the left edge of the frame, with a rattan chair tucked under it.
- Right: part of a round terracotta planter of lavender and a black metal café barrier post, cut off by the right edge of the frame.
- Under the table: pale grey sandstone slabs with fine grit, darker joints and a couple of fallen leaves.

Light: late morning, a bright, clear, sunny day, the sun high and only slightly warm, not golden hour. The pavement beyond, the kerb and the road are in bright direct sunlight. The table, her hands, the phone and the food are all in the clean, bright open shade of the awning, lit evenly by strong daylight bouncing up off the pale paving, with soft shadows under the plate, the glasses and her hands. No hard sun edge crosses the phone. Photographed on a 35mm lens at f/5.6, everything on the table sharp, the awning hem soft. Natural colour, true whites, clean and fresh, gentle contrast, real film grain. Photoreal, hyper-realistic, unretouched.
...
**C1a v2, 25 Sep 2026.** The first C1a had the right street and angle but broke continuity:
- Her table was against the window, not at the kerb under the awning's hem.
- Her hand was on her face.
- The props were missing or in the wrong places.

The trap: C1 looks at her from the front, while C2 looks down from her side, so everything on her right in C2 is on the
camera's left in C1. v2 places every item in C1's own frame terms, worked out from the chosen C2. Attach C2 as image 1
and the first C1a as image 2 (for the street, the façade and the angle only).

**C1a. Across the street, first-floor height (image 1: the chosen C2; image 2: the first C1a)**
```
Two reference images are attached. Image 1 is a close-up taken straight down over her table: use it for the exact table, the exact objects on it and where they sit, her exact clothes, hands, nails and jewellery, her chair, and the planter, the black post and the neighbouring table around her. Image 2 is an earlier wide shot of the same café: use it only for the camera angle, the street, the café's sage-green shopfront and awning, the terrace's other tables and the light. This new photograph shows the moment of image 1 from across the street. Where image 2 differs from the placement described below, follow the description.

Photograph from a small drone hovering across a narrow street from a café, looking like a real frame from a drone camera, not a render. Framing, like a real photograph: nothing needs to be fully in the frame; the awning, the shopfront, the tables, the people and the street are cut by the frame edges and hide parts of each other, as in a real, unplanned shot. The drone hovers about 4 metres above the road on the far side of the street, level with the first-floor windows and about 8 metres from the café, looking across and down at the terrace at about 35 degrees.

The terrace layout: the café's sage-green timber shopfront with tall windows runs across the back of the frame. Its sage-green canvas awning spans the whole front and projects about 3 metres out over the pavement, ending in a scalloped hem that hangs just above the front row of tables. The pavement terrace between the shopfront and the kerb holds two rows of small round white Carrara marble bistro tables on black cast-iron bases, with bamboo-framed rattan bistro chairs woven in cream and dark green. The front row sits about one paving slab back from the granite kerb.

Her table: the front-row table in the centre of the frame, one paving slab back from the kerb, directly below the scalloped hem of the awning. She sits on the far side of it, her back to the café's window, facing the street and the camera.

Her, exactly as in image 1: a woman in her mid-twenties, slim, in an oversized chunky cream cable-knit jumper with the sleeves pushed up to her forearms and light-wash straight-leg jeans. Long, glossy chestnut-brown hair, freshly blow-dried, falling forward over her shoulders as she bows her head to the phone, hiding most of her face; only the tip of her nose and her chin show. Both forearms rest on the table. Her left hand holds the phone low over the table in front of her chest, the phone leaning back towards her so that the camera sees only its dark graphite back; her right hand is raised to it with the index finger pressing the screen. A fine gold chain bracelet on her left wrist, a thin gold ring on her right hand, glossy light-pink almond nails with gold detail. Nothing touches her face. Both her hands are on the phone.

On her table, positioned from the camera's point of view (the camera faces her, so her right is the camera's left):
- Nearest the camera, on the street side of the table: the clear glass water carafe, slightly right of centre, with a half-full clear tumbler just behind it towards her; and the tall glass of iced matcha latte, pale milky jade green with a white paper straw, slightly left of centre.
- On the left half of the table (her right), in the middle: the round speckled oatmeal stoneware plate with toasted sourdough, whipped ricotta, roasted cherry tomatoes on the vine and a poached egg with a broken yolk, a brass-handled fork and knife lying on the plate.
- On the right half of the table (her left), in the middle: a pair of folded tortoiseshell sunglasses.
- On the right half of the table, on her side, next to her left elbow: her compact tan leather crossbody bag with a gold clasp, its thin strap hanging down over the table edge towards her lap.
- In her hands, in the middle of her side of the table: the phone.

Around her table, from the camera's point of view:
- To the left of her chair (her right): a large round terracotta planter of lavender, level with her.
- Further left, at the kerb edge, in front of the planter: a black cast-iron lamp post, rising out of the top of the frame.
- To the right of her table (her left): the neighbouring round marble table, empty, with a cream-and-green rattan chair tucked under it.
- In the back row, in the awning's shade, softly: two other customers in their mid to late twenties at a table on the left, a man in a dark jacket and a woman in a black top, talking over coffee.
- In the foreground at the bottom of the frame: the granite kerb, the worn double yellow line, a cast-iron drain grate with a few fallen leaves in the gutter, and the dark asphalt road in sun; the rear wheel of a parked bicycle cut off by the lower left corner.

Light, matching image 1: late morning on a bright, clear, sunny autumn day, the sun high and slightly behind the café, only slightly warm, not golden hour. The café's front and the terrace under the awning are in clean, bright open shade; the awning's scalloped hem throws its shadow onto the paving just in front of the front row of tables; the kerb and the road are in full sun. Photographed on a 24mm lens at f/5.6, sharp across the frame. Natural colour, true whites, clean and fresh, gentle contrast, fine grain. Photoreal, hyper-realistic.

Avoid: her hand on her face, her hand in her hair, one hand off the phone, her face clearly visible, looking at the camera, her table against the window, her table in the back row, objects missing from her table, a napkin, a different outfit, a different bag, a different café from the images, a wide city view, everything neatly arranged inside the frame, readable signs, shop names, writing on the awning or windows, logos, readable number plates, golden hour, sunset, orange light, fisheye distortion, tilt-shift miniature look, CGI, render, HDR, oversaturated colour, orange-and-teal grade, oversharpening, warped buildings, watermarks, extra fingers, deformed hands.
```
...
```
Bright, natural interior photograph of an independent neighbourhood café, looking like a real frame shot on film, not a render. Framing, like a real photograph: nothing needs to be fully in the frame; the counter, the cabinet, the shelves, the tables and the people overlap and are cut by the frame edges, as in a real, unposed photo of a working café. Late morning on a sunny autumn day. The camera is at counter height, about 60 cm back from the end of a long pastry counter on the right of the frame, looking along the counter and across the room towards the big front windows.
...
### Café v4: the high-street terrace (25 Sep 2026; replaces the look of v3)

Faisal sent two references: a café terrace under a dark retractable awning, and a long terrace under a cream awning
with lights on its arms. The café is now a modern café on a British high street:
- a charcoal retractable awning on black aluminium arms, with spotlights and warm bulbs;
- floor-to-ceiling black-framed glazing and warm interior light;
- olive trees and planter boxes of greenery with white flowers;
- woven wicker armchairs with cream cushions around round tables in muted sage linen;
- grey brick paving with a few autumn leaves.

The shots and the edit are unchanged from v3. C1 and C2 are new stills; C3 is an edit of C2, so the food reveal
cuts between identical frames. The awning's front valance is left blank so "Sage & Co" can go on in post.

The light is soft, warm late-afternoon daylight just before golden hour, with the interior lights, the wall lanterns
and the awning's spotlights on, as in both references. The tablecloths are a muted, greyish sage and never bright
green, so they don't compete with the green screen.

**C1. The wide, front-on from across the high street (new still)**
```
Candid street photograph of a modern café terrace on a British high street, looking like a real frame from a film camera on a tripod, not a render. Framing, like a real photograph: nothing needs to be fully in the frame; the building, the awning, the planters, the tables, the chairs and the people are cut by the frame edges and hide parts of each other, as in a real, unposed shot.

The camera: on the far pavement across the road, at standing eye level (about 1.6 metres), pointing straight at the café, square to its front, level, not tilted. Static, locked-off on a tripod. A 35mm lens at f/4.

Composition by the rule of thirds: the woman sits at the lower-left third of the frame; her head and the phone in her hands sit on the intersection one third in from the left edge and two thirds down from the top. The café front and its awning fill the upper two thirds of the frame. The road runs along the bottom of the frame.

The building: the ground floor of a handsome three-storey building on a busy high street, its upper floors in pale cream stone with tall sash windows, cut off by the top of the frame. The café's ground floor is one long front of floor-to-ceiling glazing in slim black steel frames, divided into tall panes, with cream stone pillars between the bays. Behind the glass, a warm, glowing interior: pale oak slatted blinds half raised, warm pendant lights, a long counter with a glass pastry cabinet, shelves with plants, and a few people inside, softly out of focus. Between the bays, black cylindrical wall lanterns glow warmly on the pillars.

The awning: a deep charcoal-black canvas retractable awning, extended about three and a half metres out over the terrace on slim black aluminium folding arms, the canvas taut and slightly curved. Under it, a row of small black track spotlights on the front rail and a few warm bulb lights hanging from the arms, all switched on. The awning's front edge carries a flat charcoal valance about 25 cm deep, running the full width, completely blank, with no lettering, logo or picture on it.

The terrace, on the broad pavement between the glazing and the road: two rows of round café tables, each dressed in a muted, greyish sage-green linen tablecloth falling in soft folds almost to the ground, and each with a small white ceramic vase of white spray roses and a sprig of greenery. Around them, woven wicker armchairs in warm grey-brown with rounded backs and arms, cream seat cushions and slim pale wooden legs. Olive trees in large matte black planters stand between the windows. Along the front of the terrace runs a line of low, knee-height dark grey planter boxes spilling with soft greenery, trailing ivy and white hydrangeas, broken by a gap in front of her table. The pavement is laid in grey clay brick pavers in a running bond, with a few yellow autumn leaves on them.

Her table: the front-row table at the left third of the frame, just behind the gap in the planters. She sits behind it in a wicker armchair with her back to the café's glazing, facing the street and the camera.

Her: a woman in her mid-twenties, slim and fit, attractive and photogenic in a natural, believable way, not a retouched model. Light skin with a warm undertone, fresh natural makeup, soft brows. Long, glossy chestnut-brown hair, freshly blow-dried, falling over her shoulders. Hyper-realistic skin: visible pores, fine peach fuzz, subtle variation in tone. She wears an oversized chunky cream cable-knit jumper with the sleeves pushed up to her forearms and light-wash straight-leg jeans. Her nails are a fresh gel manicure, medium-length almond shape, glossy light pink with fine gold line-art. A fine gold chain bracelet on her left wrist, a thin gold ring on her right hand. She has just sat down: relaxed, her forearms resting on the table, holding her phone in her left hand low over the table, her right index finger reaching for its screen, the back of the phone towards the camera. She looks down at it with a small, easy smile.

On her table, and nothing else: the small white vase of white roses in the middle; her compact tan leather crossbody bag with a gold clasp on the table's right side (her left), its thin strap hanging over the edge; a pair of folded tortoiseshell sunglasses beside it; a clear glass water carafe and a half-full clear tumbler towards the front. No food, no plates, no other drinks.

Around her: the neighbouring table to the right is empty, its wicker chairs tucked in. Further right and in the back row, softly: three or four other customers in their mid to late twenties at their tables, a couple talking over coffee, a man reading on his phone. On the pavement near the kerb at the right, a young plane tree in a black iron tree grate, its leaves turning yellow, and a slim black street lamp.

The road: along the bottom of the frame, the near kerb, then a strip of grey asphalt road with faded white lane markings and no cars in front of the café, the far kerb and the start of the café's pavement.

Light: soft, warm late-afternoon daylight on a clear autumn day, just before golden hour, gentle and clean rather than orange. The terrace under the awning sits in bright, soft open shade; the awning's spotlights, the hanging bulbs, the wall lanterns and the interior lights are all on, glowing warmly; a soft warm rim of daylight on her hair; the road and the pavement in front of the planters in gentle sun with long soft shadows. Natural colour, true whites, gentle contrast, real film grain. Photoreal, hyper-realistic, unretouched.

Avoid: any lettering, logo or picture on the awning's valance, readable text anywhere, writing on the windows, shop names, logos, bright or saturated green tablecloths, food on her table, other drinks on her table, her hand on her face, looking into the camera, her in the centre of the frame, the planters hiding her, a tilted or angled camera, a car or bus in front of the café, readable number plates, everything neatly arranged inside the frame, dusk, night, heavy orange sunset light, AI-generated look, CGI, render, HDR, oversaturated colour, orange-and-teal grade, oversharpening, plastic skin, beauty filter, older-looking people, chipped or unpainted nails, watermarks, extra fingers, deformed hands.
```

**C1 v2, 25 Sep 2026.** Faisal kept the look of the first C1 but not its angle:
- A wide lens from close in and off to one side made the shopfront run away to the right.
- Its lines converged.
- She sat at the frame's edge.

v2 is written as an architectural elevation: the camera's sensor is parallel to the shopfront, a 50mm lens is used from
further back across a wide road, horizontals stay horizontal and verticals vertical, and the bays are centred and equal
in width. Attach the first C1 as image 1 for the look only.

**C1. The wide, dead straight-on from across the high street (image 1: the first C1, for the look)**
```
Use the attached image (image 1) only for the look of the café: the charcoal awning, the black-framed glazing and warm interior, the wall lanterns, the olive trees, the planter boxes of ivy and white hydrangeas, the sage-green tablecloths, the wicker armchairs, the brick paving, the plane tree and the light. Do not copy its camera angle. The camera in this photograph faces the café dead straight on, as described below.

Candid street photograph of a modern café terrace on a British high street, looking like a real frame from a film camera on a tripod, not a render.

The camera and the geometry, exactly: the camera stands on the far pavement, directly opposite the middle of the café, about 14 metres from the café's glass front, across a two-lane road. It is at standing eye level, about 1.5 metres high, pointing straight at the café, level, with no tilt up or down and no turn left or right. The back of the camera is perfectly parallel to the café's glass front, so the shopfront is a flat, square-on plane facing the lens, like an architect's elevation drawing. A 50mm lens at f/5.6 from that distance keeps the perspective flat. Every horizontal line in the frame is perfectly level and parallel to the top and bottom edges of the image: the awning's front edge, the top and bottom of the windows, the tops of the planter boxes, the kerb, the edge of the road and the lane markings. Every vertical line is perfectly upright and parallel to the side edges of the image: the black window frames, the stone pillars, the lantern brackets, the olive tree trunks, the lamp post and the plane tree trunk. No line converges, and the building does not recede or turn away; its left end and its right end are the same height and the same distance from the camera. Symmetrical, calm and precise.

The shopfront across the frame: the café's glass front is divided into equal bays by cream stone pillars, and the frame shows three full bays in the middle with part of a fourth cut off at each side. Each bay is floor-to-ceiling glazing in slim black steel frames, with a black cylindrical wall lantern glowing on each pillar. Behind the glass, a warm glowing interior: pale oak slatted blinds half raised, warm globe pendant lights, a long counter with a glass pastry cabinet, shelves with bottles and plants, and a few people inside, softly out of focus. Above, a deep charcoal-black retractable awning runs straight across the full width of the frame, its front edge a perfectly horizontal line with a flat, completely blank charcoal valance with no lettering, logo or picture on it; under it, a row of small warm bulb lights on the front rail. Above the awning, a band of pale cream stone of the upper floor is cut off by the top of the frame.

The layers, from the café towards the camera, all parallel to the shopfront:
- Against the glass: an olive tree in a tall matte black planter in front of each pillar.
- The terrace, about 4 metres deep: a front row of four round café tables in muted, greyish sage-green linen tablecloths falling almost to the ground, evenly spaced along the front, each with a small white vase of white spray roses, with woven grey-brown wicker armchairs with cream cushions around them, and a second row of tables and customers behind, closer to the glass.
- The front edge of the terrace: a straight line of low, knee-height dark grey planter boxes spilling with trailing ivy and white hydrangeas, with a gap about two metres wide in front of her table.
- The pavement in front of the planters: grey clay brick pavers in a running bond with a few yellow autumn leaves; on the right, a young plane tree in a round iron tree grate and a slim black lamp post, both perfectly vertical.
- The kerb: a straight granite kerb running level across the full width of the frame.
- The road: a strip of grey asphalt with a faded white lane line running level across the bottom of the frame, empty of cars.

Her place, by the rule of thirds: her table is the front-row table whose centre is exactly one third of the way in from the left edge of the frame, standing just behind the gap in the planters, so nothing hides her. She sits behind the table, her back to the glass, facing the camera. Her head and the phone in her hands sit on the intersection one third in from the left edge and about two thirds down from the top of the frame.

Her: a woman in her mid-twenties, slim and fit, attractive and photogenic in a natural, believable way, not a retouched model. Light skin with a warm undertone, fresh natural makeup, soft brows. Long, glossy chestnut-brown hair, freshly blow-dried, falling over her shoulders. Hyper-realistic skin: visible pores, fine peach fuzz, subtle variation in tone. She wears an oversized chunky cream cable-knit jumper with the sleeves pushed up to her forearms and light-wash straight-leg jeans. Her nails are a fresh gel manicure, medium-length almond shape, glossy light pink with fine gold line-art. A fine gold chain bracelet on her left wrist, a thin gold ring on her right hand. She has just sat down: relaxed, her forearms resting on the table, holding her phone in her left hand low over the table, her right index finger reaching for its screen, the back of the phone towards the camera. She looks down at it with a small, easy smile.

On her table, and nothing else: the small white vase of white roses in the middle; her compact tan leather crossbody bag with a gold clasp on the table's right side (her left), its thin strap hanging over the edge; a pair of folded tortoiseshell sunglasses beside it; a clear glass water carafe and a half-full clear tumbler towards the front. No food, no plates, no other drinks.

The other customers: three or four people in their mid to late twenties at the tables to the right of hers and in the back row, softly: a couple talking over coffee, two friends laughing, a man reading on his phone. The table immediately to her right is empty, its chairs tucked in.

Light: soft, warm late-afternoon daylight on a clear autumn day, just before golden hour, gentle and clean rather than orange. The terrace under the awning sits in bright, soft open shade; the awning's bulbs, the wall lanterns and the interior lights are all on, glowing warmly; a soft warm rim of daylight on her hair; the pavement in front of the planters and the road in gentle sun with long soft shadows falling towards the camera. Natural colour, true whites, gentle contrast, real film grain. Photoreal, hyper-realistic, unretouched.
...
Framing, like a real photograph: nothing needs to be fully in the frame. Objects overlap and hide parts of each other, and the edges of the frame cut through the table, the chairs, the paving and anything near them, as they would in a real, unposed photo. The only things that must be fully visible are the phone's screen, with all four of its corners, and her pointing finger.

Where she sits: at the bottom edge of the frame, facing the street, in a woven wicker armchair in warm grey-brown with a cream seat cushion. From above we see only the two rounded woven wicker arms of her chair, cut by the lower corners of the frame, and between them her knees and thighs in light-wash straight-leg jeans. We never see her face, head or shoulders. Her forearms come up onto the table from the bottom edge of the frame, in the pushed-up sleeves of an oversized chunky cream cable-knit jumper.
...
- Beyond the phone, just right of the middle of the table: a small white ceramic bud vase of white spray roses with a sprig of greenery.
- On the left side of the table, in from the edge: a clear glass water carafe and a half-full clear tumbler standing together.
- Beside the carafe, nearer to her: a pair of folded tortoiseshell sunglasses.
- On the left side of the table near her left elbow: her compact tan leather crossbody bag with a gold clasp, its thin strap trailing loosely over the table edge and out of the frame.
- The right side of the table is bare tablecloth, with a few soft creases in the linen. No food, no plates, no cups.

Around the table, seen from above, all partly cut by the frame edges:
- Grey clay brick pavers in a running bond under and around the table, with a few yellow autumn leaves on them.
- Left: part of the neighbouring table in the same sage linen, with a wicker armchair tucked under it.
- Top left: the rim of a large matte black planter with the base of an olive tree's trunk and a few fallen olive leaves.
- Top right: part of a low dark grey planter box spilling with trailing ivy and white hydrangeas.

Light: the table sits in the bright, soft open shade under the café's awning, lit evenly by warm late-afternoon daylight bouncing off the pale paving, with a little warm glow from the awning's lights; soft shadows under the carafe, the vase and her hands. No sun edge and no shadow line cross the phone. Photographed on a 35mm lens at f/5.6, everything on the table sharp. Natural colour, true whites, warm and clean, gentle contrast, real film grain. Photoreal, hyper-realistic, unretouched.

Avoid: a styled flat lay, objects spread out evenly, everything neatly inside the frame, a bright or saturated green tablecloth, green objects touching the phone, food, plates, cups, a napkin, her face, her head, her shoulders, a second person at the table, the phone lying flat with no one holding it, a hand coming in from the side, fingers covering the screen corners, a finger lying along the edge of the screen, AI-generated look, CGI, render, dusk, heavy orange light, HDR, oversaturated colour, orange-and-teal grade, oversharpening, plastic skin, neon or glowing green screen, glare, reflections or shadows on the screen, chipped or unpainted nails, logos on the bag, logos, Apple logo, brand names, readable text, watermarks, extra fingers, deformed hands.
```
...
2. An iced matcha latte in a clear, straight-sided glass, a soft milky pale jade green over white milk, full, with clear ice cubes and a plain white paper straw, standing beyond the plate towards the middle of the table, well in from its edge, next to the vase of roses.

Keep everything else exactly as it is, pixel for pixel where possible: the camera angle and framing, the phone and its flat chroma-key green screen with all four corners and the black bezel visible, both of her hands and her hovering finger, her nails, bracelet and ring, the cream jumper sleeves, her jeans, the wicker chair arms, the tan bag and its strap, the sunglasses, the carafe and tumbler, the vase of roses, the tablecloth and its folds, the neighbouring table, the planters, the paving, the leaves and the light.

Avoid: any change to the phone, the screen or the green, anything on the screen, anything covering the screen, moving any existing object, cut or eaten food, a broken yolk, crumbs, a napkin, extra dishes, changes to her hands or nails, changes to the light, a different angle.
```

**C1 motion (5 s; 2–3 takes)**
```
Static, locked-off camera on a tripod; the camera does not move at all. She sits at her table using her phone: her right index finger taps the screen once, she scrolls with it, glances up at the street for a moment, then looks back down at the phone with a small smile. Behind her, the other customers talk and move naturally, the leaves of the plane tree stir, and the awning's canvas moves very slightly in a light breeze. At about two and a half seconds, a man in a dark navy wool coat walks quickly across the frame from right to left, very close to the lens, within half a metre of it, so that for about half a second his out-of-focus dark coat fills the whole frame and it goes almost completely dark. He passes out of frame on the left, and the terrace is seen again, unchanged. Only that one person passes the camera. Natural, unhurried, realistic movement; the hands keep five fingers throughout.
```

**C2 motion (5 s; 2–3 takes)**
```
The phone screen stays a solid, flat, matte chroma-key green for the entire clip; no interface, notch, status bar, icon, image, text, glare, sweep of light or reflection ever appears on it. Static camera with a very slight, slow drift in. Her left hand holds the phone steady and level, its base resting on the tablecloth; the phone does not wobble, rock, tilt or twist, and keeps its exact shape and size. Only her right hand moves. At about one second her index finger taps the upper half of the screen once, a clear, deliberate press and lift, then hovers. At about three seconds it taps the lower middle of the screen once, a clear, deliberate press and lift, then hovers just above the screen for the rest of the clip. The finger never covers a corner of the screen or lies along its edge. The roses stir very slightly in the breeze; nothing else on the table moves. The hands keep five fingers throughout. Natural, unhurried, realistic movement.
```
...
**C3 final, 26 Sep 2026.** Faisal's C3 v2 is approved. The plate is centred in front of her with the phone held over
it, the fork and knife sit beside her right hand, and the matcha is within reach on her right. The phone and her hands
match C2, so the reveal cut is clean.

**C3 motion, final (5 s; one take; start frame: the final C3)**
```
The phone screen stays a solid, flat, matte chroma-key green for the entire clip; no interface, notch, status bar, icon, image, text, glare, sweep of light or reflection ever appears on it. Static camera with a very slight, slow drift in. Her left hand holds the phone steady and level above the plate; the phone does not wobble, rock, tilt or twist, and keeps its exact shape and size. At about half a second her right index finger lifts off the screen, and her right hand moves down and a little to the right, clear of the phone, and picks up the brass-handled fork from the table beside the plate, holding it naturally. A faint wisp of steam rises from the poached egg; the ice in the matcha glints; the dappled light on the tablecloth shifts gently. Nothing else moves. The hands keep five fingers throughout. Natural, unhurried, realistic movement.
```
