...
| `motion/partner/explainer` (Partner Programme explainer for the docs, take 1) | **Olivia — Warm, British Female** `pPoztmvzd5p26S3MsNrV` | ElevenLabs `eleven_v3`, one take of the new script written to `motion/partner/BRIEF.md` v4 (every figure with its condition, per merchant, "your bonuses are yours either way"), delivery tags as the NeroConnect v3.6 take; 165.3 s raw → 139.3 s tightened at 1.03× and gated, 2,432 credits; timed with faster-whisper `small.en` in the Higgsfield sandbox. Raw take md5 `7a146627cc8e35c051f9d72d2fcf8e23` | 25 Sep 2026 | same account; flow `V5Z2DUgxnS9rAnIxR1yP`, node `E0E1aiCWVfwvSkJNMQ1O`, generation `DRJiGXu7D52vqJ5G3Txr` |
