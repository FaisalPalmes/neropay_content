...
| `motion/partner/street` (Partner Programme, style C "The High Street", the take that ships) | **Olivia — Warm, British Female** `pPoztmvzd5p26S3MsNrV` | ElevenLabs `eleven_v3`, one take of the High Street script; 60.6 s raw → 51.5 s tightened at 1.03× and gated as above, 919 credits; timed with faster-whisper `small.en` in the Higgsfield sandbox. Raw take `data/vo-raw.mp3`, md5 `640922d935a4484deecfa29e58c662dc` | 25 Sep 2026 | same account; flow `V5Z2DUgxnS9rAnIxR1yP`, node `w4QrSE2lx8ehDYjiqC2b`, generation `QbG7fXsriWVtsHE2V3VT` |
