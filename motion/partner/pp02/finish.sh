#!/bin/bash
# PP01: captions are drawn by the composition (16:9 renders without them); mux the loudnormed mix into every crop,
# contact sheet, loudness + single-frame spike report. Nothing published.
set -euo pipefail
cd "$(dirname "$0")"
EP=pp02; FONTS=../../assets/fonts-ttf
mkdir -p out/final
...
for t in 0.6 2.4 10.5 12.5 16 22 27 31 36 38.5 46.5 50.5 57.5 64 69; do ffmpeg -nostdin -y -v error -ss $t -i out/final/$EP-9x16.mp4 -frames:v 1 /tmp/claude-0/cs_$(printf '%05.2f' $t).png; done
