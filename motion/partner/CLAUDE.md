...
| 2 | `pp02/` | Your road — the network angle as one walk down one English high street, no place named; the whip hook, the receipt, the three strikes, the ring and the van, the three-shop push-in, the chart, the quiet month, the nameplate and the socials; Olivia, 52 s | **v7 delivered 18 Sep 2026 (4:5)** — v6's review: the hook clear of the labels, "no" on every struck line with the third straight after the second, a gentler shake, WHAT WE NEED · NAME · NUMBER at 150 px in a drawn frame, the socials clear of the nameplate, the crackling effects replaced and the voice compressed before the master. v6, the same day — a conversational v6 take; the whip hook with the numbered rail and the yellow question mark; flipping digits, no glass; slams with a camera shake; the ring round name and number in close; the three-shop push-in; the chart on her words with the ladder; glass socials on the close; effects quieter. v5 delivered 17 Sep 2026 (4:5) — the voice leads: every graphic on its word; a bare count that flips into the question; red strikes; the phone, the terminals and the receipts floating above the street; the revenue share as three bars over ghosted shops; the van flat on the road; the CTA stack spaced; `PROPOSAL.md`, `script.md`, `claims.md` in the folder; location lines for ads not yet recorded |
