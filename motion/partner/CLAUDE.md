...
| 2 | `pp02/` | Your road — the network angle as one walk down one English high street, no place named; the hook question, the receipt, the three strikes, the phone and the van, the lamp-post signs, the quiet month, the nameplate; Olivia, 49 s | **v2 delivered 17 Sep 2026 (4:5)** — grand figures, a fuller frame, every stop arriving; `PROPOSAL.md`, `script.md`, `claims.md` in the folder; location lines for ads not yet recorded |
