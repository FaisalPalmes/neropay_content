# PP01 — claims register (final figures, 17 Sep 2026)

Every figure that appears on screen or in the take, its source and its date. Kept beside the renders as the
substantiation record (`motion/partner/BRIEF.md`, Part 2, "Claims register"). Source for every figure: BRIEF.md v4
final, Part 1, confirmed by Faisal on 17 September 2026 (Part 7: no open questions). `figures.json` records
`partner_bonus_tiers`, `partner_revenue_share_tiers`, `partner_active_gate`, status confirmed, verified 2026-09-17.
...
| Revenue share 25% / 30% / 35% | Chips "21 · 25%", "36 · 30%", "61 · 35%", lit as the count passes each | count beside the rate at every frame | final |
| Revenue share 40% | Climb rest frame "111+ 40%" | "111+ new active merchants in one month" · "Most partners start at 20%: three a month." | final |
| Three new active merchants a month (the gate) | Hook heading "Three a month.", kicker, count 1-2-3, "not yet — 3 to qualify", compliance super "3+ new active merchants per calendar month" | "for the revenue share" | final |
...
shown are invented — a trading type and a town ("Café · Stockport", "Barber · Longsight").
