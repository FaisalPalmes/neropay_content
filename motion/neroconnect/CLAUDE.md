...
| — | `explainer-v3/` | **The explainer, rebuilt on the new brand, 24 Sep 2026** (CONTENT VIDEO session, at Faisal's request): same take, one headline and one clear-glass object per frame, no pills and no thick rims, Poppins, ends on the locked outro. Faisal's 24 Sep script carries margin, reports and support tiers, which settles the 17 Sep vs 18 Sep question for this film. `README.md` there has the figures and what is open | **v3 master rendered for review, 24 Sep 2026** |
