...
Drive (16 Sep 2026): `NeroPay Ads › 05 - Video Edits (YouTube) › MERCHANT VIDEOS › 09-2026 › Motion graphics › MG02 - The 18-month rule` (folder `1oeHnyT75J2cmSRM_lDyj6bfULDnkAuuC`),
laid out like B1 — `01 Script & voice`, `02 Test cut`, `03 Finished` holds the READ ME with the four links and the filenames to save them under
("NeroPay MG02 — Reels 9x16 (1080x1920) v6.mp4" and so on), `04 Exports` holds the master export note. The MP4s themselves
...
4:5 `9e41b26c-2b01-4b5c-b913-aa7f4d0d7a94.mp4` · 1:1 `dfe115be-e49f-4c61-ae4a-1f95c7e7f24e.mp4` ·
contact `a540666d-4f82-4251-85ca-ca7de9135c67.jpg`. Same mix as v4.1: −14.44 LUFS / −1.37 dBTP, 55.9 s, no single-frame spikes.
