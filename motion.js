...
window.MOTION = {
  ...
  videos: [
    ...
    { id: 'PP02', series: 'PARTNER', title: 'How many of the business owners on your road actually know your name?', status: 'production', ground: 'white', format: 'world', secs: 49,
      build: 'motion/partner/pp02/ — 17 Sep 2026: the network angle as one walk down one English high street, no place named (one build for every Meta location); Olivia, the approved v3 script, tightened gently; the street, a lamp post, a phone, a receipt that prints, a van, all new objects; word-by-word type, a typewriter, strikes, hanging signs, captions that pop; a new acoustic bed at 108 bpm; 4:5 first. v3, 17 Sep 2026: the voice leads — every graphic lands on the word that earns it (headings rise word by spoken word, the typewriter types each word as it is said, shops light on the word that names them), the count in a glass tile that flips into the question mark, glass slabs under the money and the climb, the van detailed and stopping at the shop, the type raised into the sky. v4, 17 Sep 2026: the count bare (no glass, no marker), red animated strikes, a heavier face on name-and-number, the phone, terminals and receipts floating in the upper half, the climb continuous in a fixed slot, the van flat on the road, the CTA stack spaced with the terminal and a parked van, soft shadows for depth. v5: the revenue share as three bars over a ghosted street, one condition line under the money',
      hook: 'How many of the business owners on your road actually know your name? (On screen: a count in a glass tile counting the shops as the view rides past them, flipping into a large "?" on "know your name", the kicker typing on her words)',
      ...
      shots: [
        { id: 'PP02-1', secs: 7, screen: 'A long paper high street; the view rides past the shops. A count in a glass tile flies in and counts 1 → 14, the shops it counts lighting as it passes, the kicker BUSINESS OWNERS ON YOUR ROAD typing on her words · on "know your name" the count flips into a large ? on the marker, the kicker retypes KNOW YOUR NAME? · Café, Barber, Takeaway light on their words with labels hanging in', say: '[curious] How many of the business owners on your road actually know your name? The café, the barber, the takeaway.', camera: 'Stop 0, facing right' },
        { id: 'PP02-2', secs: 9, screen: 'three shops light on "every one of them" · a terminal floats up over a shop on "NeroPay" · pays you rises word by spoken word · £100 – £300 lands in a glass slab that grows with the words on "hundred … three hundred" · one kicker line well below it: PER MERCHANT on "pounds", · PAID AFTER 30 DAYS WITH US on "thirty days" · a small receipt prints above the first shop on "once": PAID, after 30 days of card payments with us, small print £100 · £200 · £300 by their first 30 days\' takings', say: 'Because every one of them you introduce to NeroPay pays you a hundred to three hundred pounds, once they\'ve been taking card payments with us for thirty days.', camera: 'Stop 1, facing left' },
        { id: 'PP02-3', secs: 5, screen: 'sell anything. · set anything up. · make the call. — each word rising as she says it, struck through as she finishes the claim; a lamp post at the edge', say: 'And you don\'t sell anything. You don\'t set anything up. You don\'t even have to make the call.', camera: 'Stop 2, facing right' },
        { id: 'PP02-4', secs: 5, screen: 'Send us a name and a number. word by spoken word · a phone stands up on "send": NAME types on "name", NUMBER on "number", SENT on "close" · the van comes along the road from "send" and stops in frame at the shop on "close", its side door slides, a terminal lands at the shop door on "it", the shop lights on "for you" · three ticks pop on the phone on "three times", THIS MONTH on "month"', say: 'Send us a name and a number, and we\'ll close it for you.', camera: 'Stop 3, facing left' },
        { id: 'PP02-5', secs: 6, screen: 'the camera lands on "and you\'re an" and the street fades to a trace: week bunting with three ticks · ACTIVE PARTNER hangs in on the words · on "share" three bars rise one after another, 20% · 30% · 40%, each percentage counting up, 3+ · 36+ · 111+ merchants a month beneath · "Most partners start at 20%: three a month." on "every month"', say: '[warmly] Do it three times in a month and you\'re an Active Partner, with a share of what all your merchants\' card payments earn us, every month you hit it.', camera: 'Stop 4, facing right' },
        { id: 'PP02-6', secs: 5, screen: 'Shutters roll down on "quiet" · one shop lights on "one" · its receipt prints on "bonus" · Your bonus is yours rising on her words, either way. after', say: 'And if a month\'s quiet and you only bring one, that bonus is still yours.', camera: 'Stop 5, facing left' },
        { id: 'PP02-7', secs: 12, screen: 'FREE TO JOIN on the words · the street nameplate hangs on "NeroPay dot app", the marker draws under partners on "slash partners" · YOUR OWN LINK on "get your link" · our terminal at the kerb, inside the frame · the compliance line held to the end', say: 'It\'s free to join. Go to NeroPay dot app slash partners and get your link.', camera: 'Stop 6, the end of the road' }
      ] },
