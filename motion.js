...
window.MOTION = {
  ...
  videos: [
    ...
    { id: 'MG02', series: 'PRINT', title: 'They have to tell you.', status: 'production', ground: 'white', format: 'board', secs: 49,
      ...
      concession: 'If your deal is good, bin the message. Most of them are fine. The point is that it\'s your choice, on a date you know.',
      board: 'A calendar board: a signed contract (station 1), an 18-month bar drawn along it (2), the trigger message landing as a letter (3), the 31-day rolling strip after it (4). Camera walks the calendar left to right, pulls back on the last line.',
      higgsfield: 'None — the letter and the calendar are drawn.',
      narrator: { model: 'eleven_v3', energy: 'Hook is a quiet dare · the rule is said plainly · "eighteen months" is the hit · the concession is warm · the close is a shrug',
        tags: '[curious] on "Did you get the message?"; [serious] on the regulator line; [warmly] on the concession; no tag on the numbers, they carry themselves',
        hits: 'LEGALLY · eighteen · THIRTY-ONE · choice' },
      shots: [
        { id: 'MG02-1', secs: 5, screen: 'Off-white. Chivo, three lines, staggered: THEY HAVE / TO / TELL YOU. Serif small beneath: your card machine company, that is.', say: 'Your card machine company is LEGALLY required to tell you when you can leave. [curious] Did you get the message?', camera: 'Station one' },
        { id: 'MG02-2', secs: 7, screen: 'A contract stamps onto the calendar. An 18-month bar draws along it in yellow, Martian Mono "18 months" stamping at the end. Small: max terminal lease · PSR · Jan 2023.', say: '[serious] Since twenty twenty-three, the payments regulator caps a card terminal lease at EIGHTEEN months. Not thirty-six. Not forty-eight.', camera: 'Slide along the bar' },
        { id: 'MG02-3', secs: 7, screen: 'A letter lands at the end of the bar with a thud: "Your minimum term ends on…". Small: trigger message · from July 2023 · the 14 largest providers.', say: 'And when that term ends, they have to send you a message. In writing. Telling you the date, and telling you to shop around.', camera: 'Push into the letter' },
        { id: 'MG02-4', secs: 6, screen: 'After the letter, a strip of 31-day blocks. Chivo: THIRTY-ONE DAYS. Serif: rolling, after that.', say: 'After that it rolls month to month. THIRTY-ONE days. You can leave with a month\'s notice, not a year\'s.', camera: 'Slide right' },
        { id: 'MG02-5', secs: 7, screen: 'Pull back to the whole calendar. Serif italic, large, alone: If your deal\'s good, bin the message. Footer: PSR PS22/2, Oct 2022; applies to the 14 largest acquirers.', say: '[warmly] If your deal\'s good — bin the message. Most of them are fine. The point is it\'s your choice, on a date you know. … Check the letter. Then decide.', camera: 'Pull back' }
      ] },
