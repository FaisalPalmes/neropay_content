  ...
  videos: [
    ...
    { id: 'PP02', series: 'PARTNER', title: 'How many of the business owners on your road actually know your name?', status: 'production', ground: 'white', format: 'world', secs: 49,
      ...
      shots: [
        ...
        { id: 'PP02-2', secs: 9, screen: 'three shops light on "every one of them" · a terminal lands at a door on "NeroPay" · pays you rises word by spoken word · £100 – £300 lands in a glass slab on "hundred … three hundred" · PER MERCHANT on "pounds" · the door prints a receipt on "once": PAID, after 30 days of card payments with us, small print £100 · £200 · £300 by their first 30 days\' takings · paid after 30 days of card payments with us. on "thirty days"', say: 'Because every one of them you introduce to NeroPay pays you a hundred to three hundred pounds, once they\'ve been taking card payments with us for thirty days.', camera: 'Stop 1, facing left' },
        ...
        { id: 'PP02-5', secs: 6, screen: 'the camera lands on "and you\'re an": week bunting with three ticks and three lit shops · ACTIVE PARTNER hangs in on the words · the climb in a glass slab on "share": 3 → 20% … 111+ → 40%, resting on "Most partners start at 20%: three a month."', say: '[warmly] Do it three times in a month and you\'re an Active Partner, with a share of what all your merchants\' card payments earn us, every month you hit it.', camera: 'Stop 4, facing right' },
