...
window.MOTION = {
  ...
  series: [
    ...
    { id: 'PRINT', name: 'Small Print', status: 'brief', pillar: 'Statement', channel: 'Reels, Shorts, TikTok 9:16 · LinkedIn 16:9',
      ...
      folder: 'motion/print/' },
    { id: 'PARTNER', name: 'Partner Programme', status: 'draft', pillar: 'Partner', channel: 'Meta and TikTok 9:16 · 1:1 and 4:5 feed · LinkedIn and YouTube 16:9',
      ...
      note: 'DRAFT builds only until Eray clears the three CONFIRM items (top tier £300/£500 · the definition of active · the base and timing of the share). figures.json holds the figures as status draft; every export is -DRAFT; nothing posts.',
      folder: 'motion/partner/' }
  ],

  videos: [

    { id: 'PP01', series: 'PARTNER', title: 'The catch, up front.', status: 'draft', ground: 'charcoal', format: 'world', secs: 70,
      build: 'motion/partner/pp01/ — DRAFT, 17 Sep 2026: one continuous UGC script (Faisal\'s rewrite note), Olivia take tightened at 1.06x and breath-gated, the dark world, the Bonus Dial and the Rate Climb as glass slabs, an upbeat generated bed, 35 cues; four crops named -DRAFT, awaiting review',
      hook: 'Okay, here\'s the catch first, because we\'d rather you heard it from us than found it in the terms. (On screen: We\'ll tell you the condition first. · The catch, up front. · Three a month.)',
      ...
      source: 'motion/partner/BRIEF.md, Part 1 (Faisal, 16 Sep 2026). Figures in figures.json as partner_bonus_tiers, partner_revenue_share_tiers, partner_active_gate — status draft.',
      figures: ['partner_bonus_tiers', 'partner_revenue_share_tiers', 'partner_active_gate'],
      concession: 'And if you have a quiet month and only bring one, you still get that bonus, it\'s yours either way.',
      cta: 'partners.neropay.app · Free to join · Get your link · compliance super: £100–£300 per merchant. Revenue share needs 3+ new active merchants per calendar month. Terms: partners.neropay.app',
      board: 'Six sections on the arc, dark ground. The catch (three shops light 1-2-3 under "three"); the programme (café, takeaway, barber rise and light; YOU INTRODUCE · WE SET UP · WE SUPPORT); the bonus (a ledger row goes LIVE, the Bonus Dial runs £100 → £200 at £20,000 → £300 at £40,000 and rests with its condition; three steps rise on the floor); the share (the Rate Climb 0 → 3 → 20% … 111+ → 40%, "Most partners start at 20%: three a month."; the path of tiles lights); either way (one shop, its £100 row, the line); the close (our terminal, the address, the compliance line held 6 s).',
