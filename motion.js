...
window.MOTION = {
  ...
  videos: [
    ...
    { id: 'PP01', series: 'PARTNER', title: 'The catch, up front.', status: 'production', ground: 'white', format: 'world', secs: 70,
      build: 'motion/partner/pp01/ — v2, 17 Sep 2026: one continuous UGC script (Faisal\'s rewrite note), Olivia take tightened at 1.06x and breath-gated, the white world with a camera that never stops, spheres, the view swinging left and right, the Bonus Dial and the Rate Climb as glass, phrases as graphics, an upbeat generated bed, 35 cues; 4:5 first, awaiting review',
