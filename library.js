...
window.LIBRARY = {
  ...
  videos: [
    ...
    { id: 'NCEX', series: 'NeroConnect', title: 'NeroConnect explainer',
      version: 'v3.4', rendered: '2026-09-24', secs: 148,
      status: 'review', by: 'content video session, 24 Sep 2026 — v3 rebuilt at Faisal\'s request, awaiting his review',
      waiting: 'Faisal watches v3.4 (24 Sep, his notes on v3.3): reveals back on her words (ten list timings had missed the retime), "minimum" replaces "floor" in voice (spliced, same voice, 178 credits) and on screen, the demo platform is Keelstone Pay in blue (checked: no payments business by that name), the report figures slide and count in, a yellow flash on what she names, the outro holds 2.5 s longer. Before that, v3.3: re-voiced in one new take with tone (2,254 credits, ledger row), the closing question "So… are you ready to run payments under your own name?" said and shown under "Your brand.", "Reports" whole (tighten.mjs now keeps any gap with speech in it), "your merchants see" fixed, every reveal retimed to the new take (retime.py). Before that, v3.2: Saffron Lane flashes on "identity checks", the five steps walk in yellow, "Your store. Your prices." marked, "Reports" restored from the raw take, the last line holds 3 s before the outro, a glass N bottom right, the light at the edges and moving, the bed raised with scene changes on its beat, and on screen "No payment priced at a loss." instead of "never lose money" (rail 2). The opening photos are to be regenerated hyper-real (HIGGSFIELD-PROMPTS.md D1–D3). Before that, v3.1: v3 plus his Higgsfield photos (the unbranded terminal with YOUR LOGO, till, accessories, café, takeaway, shop) in the opening, branding, store and close, and the text jitter fixed (type is never scaled; check-still.cjs gates every render). v3 was rebuilt on the new brand from his 24 Sep notes on v2 (minimal, clear glass, no pills, no bevel edges, Poppins, ends on the locked yellow outro). Same take as v2. Two script points open: re-voice "so you can never lose money on a service" (rail 2 register) and the "your merchant see" slip. The 17 Sep vs 18 Sep question is settled by his 24 Sep script, which carries margin, reports and support tiers. The master exists only as a chat attachment until it is put in the Drive folder. No 9:16 or 1:1 cut yet.',
      ...
      files: [
      { crop: '16:9 master', px: '1920×1080', mb: 28.4, md5: '64ecf30908b128377de905d13ca18bdc', lufs: '−14.05', where: 'v3.4 sent in chat 24 Sep 2026; not yet in Drive' },
