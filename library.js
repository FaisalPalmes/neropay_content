...
window.LIBRARY = {
  ...
  videos: [
    ...
    { id: 'NCEX', series: 'NeroConnect', title: 'NeroConnect explainer',
      version: 'v3.6.2', rendered: '2026-09-25', secs: 145,
      ...
      files: [
      { crop: '16:9 master', px: '1920×1080', mb: 29.3, md5: 'dd4f6d1a07eb36b39aee6fb44472303e', lufs: '−15.61', where: 'v3.6.2 (Faisal 25 Sep: his three photos in the opening tiles, the third labelled Restaurants; music at 20% again, voice unchanged) sent in chat; not yet in Drive' },
      { crop: '1:1', px: '1080×1080', mb: 20.8, md5: '320559f9103d3ba05ac6351c036d6120', lufs: '−15.61', where: 'v3.6.2 square: the new tiles, and the terminal moved to the right-hand middle in the hook and the swap; sent in chat; not yet in Drive' },
      { crop: 'v3.6.1 16:9 and 1:1 (superseded)', px: '—', md5: '4a95c79a5875e35b854d30956b6f1cec / fc480f805caa1d5e11e8bf83bb40f9fe' },
