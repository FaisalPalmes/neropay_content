...
window.LIBRARY = {
  ...
  videos: [
    ...
    { id: 'AS01', series: 'App Store', title: 'App preview — iPhone',
      version: 'v6', rendered: '2026-09-23', secs: 29.0,
      status: 'review', by: 'unrecorded — v6 built on the carousel stills at Faisal\'s request, 23 Sep, and sent for his review',
      waiting: 'Faisal watches v6, rebuilt from the carousel stills he signed off: the six slides on their pink-and-blue grounds, swiped through like the carousel, with a tap or a lift on each. v5 (3D phone, glass stripes, the swish outro) is superseded; the outro is kept.',
