...
window.LIBRARY = {
  ...
  videos: [
    ...
    { id: 'AS01', series: 'App Store', title: 'App preview — iPhone',
      version: 'v8', rendered: '2026-09-23', secs: 29.0,
      status: 'review', by: 'unrecorded — v8 made on Faisal\'s 23 Sep notes on v7 and sent for his review',
      waiting: 'Faisal watches v8: the keypad amount no longer pops out, and a light runs through it instead; the pop-ups sit tilted on each phone\'s top edge. He liked v7\'s copy, overlays and keypad. "Flat rate" and "Amex" stay out of the pop-ups until Eray confirms them.',
      ...
      note: 'The six carousel slides at the stills\' own 660 × 1434: the hero with the Visa card, the keypad and the transactions list in the yellow glass outline, the three hand photographs. Each swipe pulls the slide back into a card, slides across and pushes in, with the art trailing for depth. Each slide has its moment: the contactless signal, keys and CHARGE pressed, a tap and the dish card lifting, the NeroWeb row, the total and tooltip, the amount field. Hands and glass are baked from the stills page (stills/render.cjs layers); grounds, copy, taps and lifts are live. The Shutter intro and the v5 swish into the mark on the glass tile are kept. No voiceover, no captions. v1–v5 are in archive/. The iPad (1200×1600) and Google Play (1080×1920) cuts are made from the same composition (fit.js, render-all.sh), 23 Sep, with seven screenshots per store; all three are in one zip on Higgsfield.',
      files: [
        { crop: '9:16 App Store iPhone', px: '886×1920', lufs: '−13.9', media: '5fe76e7d-ae80-4b99-a508-2dd371b5335a', md5: 'd1cbf2dc473d38e04c6b6eb788a8d766' },
        { crop: '3:4 App Store iPad', px: '1200×1600', lufs: '−13.9', media: '16e7bb4b-4919-4136-99c5-61608eaff051 (zip, all three stores)', md5: 'c4e1b15b3af828cb1e63b604affadfa4' },
        { crop: '9:16 Google Play promo', px: '1080×1920', lufs: '−13.9', media: '16e7bb4b-4919-4136-99c5-61608eaff051 (zip, all three stores)', md5: 'c0f5fdb436cbf3c607ee5101d796d860' },
