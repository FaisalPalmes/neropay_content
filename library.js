...
window.LIBRARY = {
  ...
  videos: [
    ...
    { id: 'AS01', series: 'App Store', title: 'App preview — iPhone',
      version: 'v7', rendered: '2026-09-23', secs: 29.0,
      status: 'review', by: 'unrecorded — v7 made on Faisal\'s 23 Sep notes on v6 and sent for his review',
      waiting: 'Faisal watches v7: the keypad amount now starts at £0.00 and fills in live, and every slide has pop-ups. "Flat rate" and "Amex" were left out of the pop-ups until Eray confirms them. v6 (the carousel-based rebuild) is superseded.',
      ...
      files: [
        { crop: '9:16 App Store iPhone', px: '886×1920', lufs: '−13.9', media: 'e4a8f9c0-f802-473b-878f-599af38d1060', md5: '5a044d460b3a8480024ceeb3a0ad8f46' },
