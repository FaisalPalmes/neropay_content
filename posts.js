...
/* ============================ ADDED 17 SEP 2026 — NeroConnect · partner programme · card machines ============================ */
{
  ...
  copy: "Three kinds of business have asked us the same thing this year: whether the card payments could carry their name instead of ours.\n\nEPOS installers who fit tills for a living. Software companies with a few hundred restaurants on their platform. Anyone looking after a group of merchants who is tired of six logins.\n\nNeroConnect is the answer to that. One dashboard for every merchant you look after. Your logo, your domain, your merchant pricing. We run the card acquiring, the settlement and the compliance underneath. You keep the relationship.\n\nTwo ways to set it up, and the difference is who pays NeroPay's processing fee: your platform pays it and bills your merchants yourself, or each merchant pays it directly with your fee on top. Merchant pricing is yours in both.\n\nTwo things it isn't. If you look after three cafés, this is the wrong door. The partner programme is built for that: one introduction, no platform to run. And depending on the setup there can be regulatory questions on your side, which is a conversation before a contract, not after.\n\nThe documentation is public. docs.neropay.app, the NeroConnect section. Read it before you talk to us. It is more use than the sales call.",
  ...
  assets: [
    { t: "cards", size: "pt", alt: "A six-card carousel on a light background describing NeroConnect, NeroPay's white-label payments platform for installers and software platforms. Plain text on frosted panels, NeroPay wordmark bottom left.", cards: [
      ...
      { n: "Two ways", h: "Who pays our processing fee.", b: "Your platform pays it and bills your merchants, or each merchant pays it directly with your fee on top. Merchant pricing is yours either way." },
